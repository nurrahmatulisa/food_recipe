...
class create1ResepState extends StatefulWidget {
  const create1ResepState({super.key});

  @override
  State<create1ResepState> createState() => _create1ResepStateState();
}

class _create1ResepStateState extends State<create1ResepState> {
              ...
              children: [
                ...
                TableCell(child: Row(
                  ...
                  children: [
                    ...
                    IconButton(onPressed: () => {Navigator.push(context, MaterialPageRoute(builder: (context) => create1State()))}, icon: Icon(Icons.delete, color: kRedColor))
                  ],
                ),
                ),
              ]
